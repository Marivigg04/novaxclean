  ...
  const handleSaveProfile = async (nextProfile) => {
    ...
    try {
      ...
      showInventoryToast({
        ...
        message: 'Los datos del administrador se guardaron correctamente.',
      });
    } catch (error) {
      showInventoryToast({
        type: 'delete',
  ...
  const handleUploadPhoto = async (files) => {
    ...
    try {
      ...
      showInventoryToast({
        ...
        message: 'Tu foto de perfil se guardó correctamente.',
      });
    } catch (error) {
      showInventoryToast({
        type: 'delete',
  ...
  const handleRemovePhoto = async () => {
    ...
    try {
      ...
      showInventoryToast({
        ...
        message: 'Se restauró el avatar por defecto.',
      });
    } catch (error) {
      showInventoryToast({
        type: 'delete',
